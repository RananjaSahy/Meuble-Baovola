    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="../Insertion/materielInsertion.html" class="active">
              <i class="bi bi-circle"></i><span> Matière </span>
            </a>
          </li>

          <li>
            <a href="../Insertion/styleInsertion.html" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tableau liste style/matières</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class=" offset-2 col-lg-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tableau liste style/matières</h5>
                  <p><code> Voici la liste de tout les styles et de des matières utilisée</code> </p>
                  <!-- Bordered Table -->
